...
"lon" is also used to say that something is written or exists *in* a language:

> lipu ni li lon toki Kanse. -- This article is in French.
>
> nimi mute li lon toki pona. -- Many words exist in toki pona.
>
> mi sitelen e lipu ni lon toki Kanse. -- I wrote this letter in French.

Note: for a *written text*, use `lon toki X` (the text exists in that language), not `kepeken toki X` (which is for speaking).

> mi en sina li sama. -- You and I are similar.

> meli sama mi li pona. -- My sister is good. (meli = noun; sama = "sibling/same-level relative"; also: mije sama = brother, jan sama = sibling/gender-neutral, mama sama = aunt or uncle)

When "sama" follows a pronoun, it creates a reflexive meaning ("oneself"):

> ona li lukin e ona sama. -- They looked at themselves.
>
> mi pona e mi sama. -- I improve myself.

> kiwen lili li sama pipi tawa lukin. -- The pebble ("small rock") looks like a bug.

> mi lape tan ni: mi jo ala e wawa. -- I sleep, because i don't have any energy.

> mi pali tan ni: mi wile e ni. -- I do it because I want to.
...
> tomo tawa linja -- train ("moving house on rails/lines"); also "linja tomo tawa"

> tomo tawa kulupu -- bus ("group moving house")
...
The **subject is always the thing liked**, and the person who likes it follows `tawa`:

> kili li pona tawa mi. -- I like fruit.
>
> telo nasa li ike tawa mi. -- I dislike alcohol.
>
> seme li pona tawa sina? -- What do you like?

A common mistake is to reverse the structure. `mi pona tawa sina` means "I am good to you"
(i.e., *you* like *me*), not "I like you".

When something "is the same to you" from your perspective, use `sama tawa`:

> ni li sama tawa mi. -- I don't care. ("This is the same to me.")

This is different from `mi pilin ala` (I feel nothing = emotional numbness).

Note: `olin` is reserved for deep, intimate love (romantic or parental bonds). For
preferences — even about people one is fond of — use `pona tawa`. "I like children" or
"I'm fond of them" is `jan lili li pona tawa mi`, not `mi olin e jan lili`.
`pilin ike` means to feel emotionally bad, not to dislike something.

Intellectual interest uses `pona tawa sona`: `nasin sona ni li pona tawa sona ona.` (He is interested in this philosophy.)

Places are described by purpose — `tomo telo nasa` = bar, `esun pi mani lili` = cheap shop.

> %warning%
> Do not confuse "pona e X" (to fix/improve X) with "X li pona tawa Y" (Y likes X). For example: "mi pona e tomo" = "I fix the house", but "tomo li pona tawa mi" = "I like the house".
...
The compound "ilo toki" (communication device) means phone or radio. Use
"kepeken ilo toki" to mean "to call" or "to phone":

> o kepeken ilo toki tawa mi! -- Call me! / Phone me!

> sina kama jo e sona sin la o kepeken ilo toki tawa mi. -- If you find anything out, call me.
