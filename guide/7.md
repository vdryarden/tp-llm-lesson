...
A common idiom: `anpa e monsi` means "to sit down" (lower one's back/rear):

* ona li anpa e monsi lon poka mi. -- She sat down next to me. (action of sitting)

To describe being *seated* in a chair (state, not action), use `kepeken supa monsi`
(using an armchair / seat) or simply `lon anpa` (be in a low position).

**Misunderstanding**: `kute ike e toki mi` = misheard/misunderstood me; `sona ike e toki mi` = interpreted my words wrongly.
...
"o" after any noun phrase also expresses "should" or "must":

> jan Ton o kama. -- Tom must come.

> ona o pali e ni. -- She should do this.
