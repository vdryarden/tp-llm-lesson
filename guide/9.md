...
When translating complex sentences, lead with the experiencer. Use `la`/`tan ni la` to restructure:
`mi kama lape tan nasin sona ni.` ("The science makes me sleepy.")

**toki musi** = poetry/artistic speech. (Not `toki pona` = "good speech" or the language.)
