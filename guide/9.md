...
It is also useful for using common phrases or multi-word modifiers:

> jan toki utala -- a speaker warrior 

> jan pi toki utala -- a critic

When a modifier consists of more than one word, use "pi" to group it:

> ilo sitelen tawa -- a moving-picture tool (could be parsed as "a moving tool that draws")

> ilo pi sitelen tawa -- a television / video player ("tool of moving pictures")

> ilo pi toki kalama -- a telephone/radio ("tool of spoken sound")
...
The word "len" (cloth) combines with body-part words for specific clothing:

> len sijelo -- clothing ("body cloth")

> len noka / len selo noka -- footwear ("foot cloth" / "outer-form foot cloth")

> jan li esun e len sijelo e len selo noka. -- The person sells clothes and shoes.
...
> pilin la ona li lili. -- He is young at heart. ("Emotionally, he is small/young.")

> pilin la, mi wile tawa. -- Deep down, I want to go. ("In terms of feeling, I want to go.")
...
> ante la... -- Otherwise, ... (literally: "In a different context, ...")

> pini la... -- Finally, ... / At last, ... (literally: "Finished/ended, ...")
