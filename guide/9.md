...
Note: `mute` alone means "very" (intensifying). To say something is *too* much of a
quality — more than desired — use `pi mute ike` ("of bad/excessive quantity"):

> pan suwi ni li suwi pi mute ike tawa mi. -- This cake is too sweet for me.
>
> kalama ni li suli pi mute ike. -- This sound is too loud.
...
When translating complex sentences, lead with the experiencer rather than the abstract
cause; use `la` and `tan ni la` to restructure. For example, "the science makes me sleepy"
becomes `mi kama lape tan nasin sona ni` (I fall asleep because of this knowledge system).

Note: poetry or artistic speech is `toki musi`, not `toki pona` (= "good speech" or the
language). `ona li jan pi toki musi.` -- He is a poet.
...
The word "len" (cloth/clothes) can be used as a verb meaning "to cover" or "to hide":

> olin li len e pakala ale. -- Love covers all faults.
