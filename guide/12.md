...
**pan** covers bread and grain-based foods. Prefer specific compounds over generic `moku + adjective`:
`pan suwi` (cake), `suwi lete` (ice cream), `kili sike loje` (apple).

Here are some useful compound expressions that use these words:

**`pilin uta`** (mouth-feeling) = taste:

> pan suwi ni li jo e pilin uta suwi. -- This cake has a sweet taste.

**`kepeken kon`** (use air) = to breathe:

> jan Ton li kepeken kon. -- Tom breathes.

**`pilin e weka [X]`** (feel the absence of X) = to miss someone:

> mi pilin mute e weka ona. -- I miss her a lot. (feel her absence greatly)

**`pana e kon jaki`** (emit foul air) = to smell bad; **`pana e kon pona`** = to smell good:

> ko ni li pana e kon jaki. -- This slime smells bad.
