...
> jan Ton li lape ala. -- Tom is awake. ("Tom is not sleeping.")
...
The word "pakala" by itself is also used as a short apology: `mi pakala.` (I erred /
I'm sorry). To ask for forgiveness, use `o weka e ike mi.` (remove the bad from me).
