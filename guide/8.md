...
The word "nasa" combines with other words to describe intoxication:

> telo nasa -- alcohol ("strange water")

> jaki nasa -- drugs / intoxicants ("toxic strange substance")

Note: use "kepeken" (to use/consume) — not "moku" — with intoxicants:

> jan Ton li kepeken telo nasa. -- Tom drinks alcohol.

> jan Ton li moku e telo nasa loje. -- Tom drinks red wine. ("strange red water")
