...
There is an exception to the rule. If the subject is "mi" or "sina", then "li"
is **omitted** (never used). So:

> sina suli. - You are important.

> mi pona. - I am good.

Never write "sina li ..." or "mi li ..." — "li" is always dropped for these subjects.
This applies in ALL cases, including when the predicate is itself a pronoun:

> WRONG: mi li pona. sina li suli.
> CORRECT: mi pona. sina suli.

> WRONG: sina li sina. mi li mi.
> CORRECT: sina sina. mi mi. - You are you and I am me.
