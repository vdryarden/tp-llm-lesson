...
Toki pona has no passive voice. Use active constructions; if the agent is unknown, use "jan" (person/people) as the subject:

> jan li esun e len lon ma tomo. -- Clothes are sold in the city. ("A person sells clothes in the city.")

> jan li kama sona e ijo mute lon tomo sona. -- Many things are learned at school.
