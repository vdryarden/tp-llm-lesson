...
> sina kama tan seme? -- Where do you come from? (not "sina tan ma seme")

> luka mi tu li kama wan. -- Our two hands came together / met. ("became one")
...
For purpose clauses ("in order to"), use "tawa ni: [full sentence]":

> mi mute li tawa tomo sona tawa ni: mi mute li kama sona. -- We go to school in order to learn.

> mi pali e ijo tawa ni: mi ken lon. -- I work in order to survive.
...
You can also use "tenpo ala" and "tenpo ale" for "never" and "always":

> tenpo ala la mi moku e soweli. -- I never eat meat.

> tenpo ale la telo li pona. -- Water is always good.

The "tenpo ala la" pattern is required for commands meaning "never":

> tenpo ala la o weka e ona. -- Never forget it! (NOT "o weka ala e ona" which means only "don't forget it")

> tenpo ala la o toki ike. -- Never speak badly.
