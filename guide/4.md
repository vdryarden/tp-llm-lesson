...
> telo tawa li suli. - The river ("flowing/moving water") is big.
...
When describing speaking *in* a language, use `kepeken toki X` (community standard) or
`lon toki X` (official book). Do NOT use `e toki X` — that means *talking about* the language:

> ona li toki pona kepeken toki Kanse. -- She speaks French well.
>
> meli sama mi li toki ala kepeken toki Inli. -- My sister doesn't speak English.
>
> sina toki pona lon toki Inli. -- You speak English well.

Compare: `ona li toki e toki Kanse` = they are talking *about* the French language.
