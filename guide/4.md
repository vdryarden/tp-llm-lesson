...
When describing how well someone speaks a *language*, use "kepeken" rather than "e"
or "lon" — otherwise the language itself becomes the topic, not the medium:

> ona li toki pona kepeken toki Kanse. -- She speaks French well. (uses French as the medium)
>
> ona li toki ike kepeken toki Kanse. -- He speaks poor French. (speaks badly, using French)

Compare: `ona li toki e toki Kanse` means they are *talking about* the French language,
not speaking it.
