...
**monsuta** is commonly used for fear and its objects. Use `pilin monsuta` for
being afraid, not the generic `pilin ike` (feel bad):

> mi pilin monsuta. -- I am afraid.
>
> mi pilin monsuta tawa seli. -- I am afraid of fire.

**kipisi** (cut/divide) is commonly used for cutting tools: `ilo kipisi` = knife, scissors.
